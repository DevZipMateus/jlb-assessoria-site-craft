    ...
    <section id="about" className="py-20 bg-gradient-to-b from-background to-secondary/20">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto mb-20 text-center animate-fade-in">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-foreground">Nossa missão</h2>
        ...
        <div className="max-w-5xl mx-auto mb-20 animate-fade-in">
          <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center text-foreground">Nossa história</h2>
        ...
        <div className="animate-fade-in">
          <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center text-foreground">Nossos valores</h2>
